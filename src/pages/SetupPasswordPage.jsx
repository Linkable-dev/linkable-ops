  ...
  if (!sessionReady) return (
    <div style={{
      ...
      <div style={{ textAlign: "center", maxWidth: 360, padding: 24 }}>
        <div style={{ fontSize: 15, fontWeight: 600, marginBottom: 8 }}>Invalid or Expired Link</div>
        <p style={{ color: theme.textMuted, fontSize: 13, margin: 0, marginBottom: 16 }}>
          This invite link may have expired. Ask an admin to send a new invite.
        </p>
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 380, padding: 24 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 600, color: theme.text, margin: "12px 0 4px" }}>Welcome to Linkable OPS</p>
          <p style={{ fontSize: 13, color: theme.textMuted, margin: 0 }}>Set a password to complete your account setup</p>
        </div>
