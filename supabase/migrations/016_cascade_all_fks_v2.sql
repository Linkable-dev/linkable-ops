-- Re-run of 003_cascade_all_fks.sql: some tables (external_creators,
-- instagram_analytics, etc.) were created directly against the DB after 003
-- ran and shipped with FKs that don't cascade, breaking deletes on their
-- parent rows. Same idempotent rewrite, scoped to whatever's still non-cascade.
